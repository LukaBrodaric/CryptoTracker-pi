  ...
  <div class="home">
    ...
    <body>
      <section class="container currency-div">
        ...
        <div class="single-currency" data-item="currency-bnb">
          <div class="currency-price-div">
            <div class="left">
              <img src="@/assets/bnb.png" alt="" class="currency-logo" />
              <div>
                <h4 class="sort-name">bnb</h4>
                <span class="full-name">Binance coin</span>
              </div>
            </div>
            <div class="right">
              <h4 class="current-price">${{ this.cryptos.BNB.USD }}</h4>
              <span class="currency-qnt">1.00 bnb</span>
            </div>
          </div>
          ...
          <div class="currency-balance-div">
            ...
            <div class="right">
              <h5>${{ (this.cryptos.BNB.USD * this.BNB).toFixed(2) }}</h5>
            </div>
          </div>
...
.currency-div .balance-reminder.bnb-reminder {
...
setTimeout(() => {
store.pocetnaVrijednost = this.cryptos.BNB.USD ;
console.log(store.pocetnaVrijednost)
  ...
  methods: {
    getWallet() {
      ...
      if(store.pocetnaVrijednost - this.cryptos.BNB.USD > (store.pocetnaVrijednost/100*this.pBNB)) {console.log("Cijena je skocila");}
      if(store.pocetnaVrijednost - this.cryptos.BNB.USD < (store.pocetnaVrijednost/100*this.pBNB)) {console.log("Cijena je pala");}
      }
    },
    setReminder(){
