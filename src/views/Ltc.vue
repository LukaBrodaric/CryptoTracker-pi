        ...
        <div class="single-currency" data-item="currency-ltc">
          ...
          <div class="currency-news-div">
            ...
            <ul class="news-list">
              <li>
                <div>
                  <h3 class="news-title">AMC Theaters</h3>
                  <p>Now you can pay with Litecoin for a movie</p>
                </div>
                <ion-icon name="reorder-two"></ion-icon>
              </li>
              <li>
                <div>
                  <h3 class="news-title">Safe investment option</h3>
                  <p>Can we call Litecoin a safe investment option?</p>
                </div>
                <ion-icon name="reorder-two"></ion-icon>
              </li>
            </ul>
