...
setTimeout(() => {
store.pocetnaVrijednost = this.cryptos.ADA.USD ;
console.log(store.pocetnaVrijednost)
  ...
  methods: {
    getWallet() {
      ...
      if(store.pocetnaVrijednost - this.cryptos.ADA.USD > (store.pocetnaVrijednost/100*this.pADA)) {console.log("Cijena je skocila");}
      if(store.pocetnaVrijednost - this.cryptos.ADA.USD < (store.pocetnaVrijednost/100*this.pADA)) {console.log("Cijena je pala");}
      }
    },
    setReminder(){
