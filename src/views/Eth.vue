      ...
      <section class="container currency-div">
        ...
        <div class="single-currency">
          <div class="currency-price-div">
            <div class="left">
              <img src="@/assets/eth.png" alt="" class="currency-logo" />
              <div>
                <h4 class="sort-name">eth</h4>
          ...
          <div class="balance-reminder eth-reminder">
            ...
            <ul class="news-list">
              <li>
                <iframe
                  ...
                  frameborder="0"
                  src="https://cryptopanic.com/widgets/news/?bg_color=FFFFFF&amp;currencies=ETH&amp;font_family=sans&amp;font_size=20&amp;header_bg_color=FFFFFF&amp;header_text_color=FFFFFF&amp;link_color=000000&amp;news_feed=recent&amp;posts_limit=3&amp;text_color=2C3E50&amp;"
                  height="350px"
                ></iframe>
...
setTimeout(() => {
store.pocetnaVrijednost = this.cryptos.ETH.USD ;
console.log(store.pocetnaVrijednost)
  ...
  methods: {
    getWallet() {
      ...
      if(store.pocetnaVrijednost - this.cryptos.ETH.USD > (store.pocetnaVrijednost/100*this.pETH)) {console.log("Cijena je skocila");}
      if(store.pocetnaVrijednost - this.cryptos.ETH.USD < (store.pocetnaVrijednost/100*this.pETH)) {console.log("Cijena je pala");}
      }
    },
    setReminder(){
